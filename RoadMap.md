...
## Milestone 17: Property Arithmetic in Style Blocks

- [ ] Enhance the `Lexer` to support arithmetic operators.
- [ ] Update the AST to represent arithmetic expressions.
- [ ] Update the `Parser` to parse arithmetic expressions.
- [ ] Update the `Generator` to resolve arithmetic expressions.
- [ ] Write unit tests for the property arithmetic feature.
